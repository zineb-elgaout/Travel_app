...
export const MOCK_FAVORITES: ExploreItem[] = [
  {
    ...
    image: 'https://ims.ev.mu/large_metaeditor_4_747b8aff6a/large_metaeditor_4_747b8aff6a.jpg',
    rating: 4.8,
    isFavorite: true,
    type: 'cities',
    subType: 'imperial',
  ...
  },
  {
    ...
    image: 'https://tse3.mm.bing.net/th/id/OIP.EPNnDOvo_dzpL7NGNHWO0wHaEc?rs=1&pid=ImgDetMain&o=7&rm=3',
    rating: 4.6,
    isFavorite: true,
    type: 'cities',
    subType: 'coastal',
